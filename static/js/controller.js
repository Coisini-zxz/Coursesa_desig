...
function get_l2_data() {
    $.ajax({
        url:"/L2",
        success: function(data) {
            ec_left2_Option.xAxis[0].data=data.data_time
            ec_left2_Option.series[0].data=data.new_diagnosis
            ec_left2_Option.series[1].data=data.new_cure
			ec_left2_Option.series[2].data=data.new_cure
